// Mirrors backend/utils/seoScore.js exactly so the writer sees the same
// score while typing that gets saved when they hit save. Kept dependency-free.
...
export const calculateSeoScore = ({ title = "", content = "", metaDescription = "", slug = "", focusKeyword = "" }) => {
